					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="log_username" id="log_username" required placeholder="Username">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
								...
								<input type="hidden" class="form-control" name="old_password" id="old_password" placeholder="Password">
							</div>
						</div>
						...
						<!-- <div class="col-lg-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="log_nama" id="log_nama" required placeholder="Username">
							</div>
						</div> -->
						<div class="col-lg-6">
							<div class="form-group">
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<select class="form-control select" name="log_pgw_id" id="log_pgw_id" style="width:100%;line-height:100px;" required>
									<option value="">== Pilih ==</option>
									<?php foreach ($pegawai as $p) { ?>
										<option value="<?= $p->pgw_id ?>"><?= $p->pgw_nama ?></option>
									<?php } ?>
								</select>
							</div>
						</div>
				...
				obj.map((dt) => {
					if (dt[0] == "pgw_foto") {
						$(".img-preview").attr("src",
							"<?= base_url('assets/files/pegawai/') ?>" + dt[1]);
					} else if (dt[0] == "log_pgw_id") {
						$("#" + dt[0]).val(dt[1]).change();
					} else if (dt[0] == "log_password") {
						$("#old_password").val(dt[1]);
					} else if (dt[0] != 'log_id') {
						$("#" + dt[0]).val(dt[1]);
					}
